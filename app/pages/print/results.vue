  ...
  export default {
    ...
    methods: {
      async setRows() {
        ...
        let intervals = {
          'January': {
            from: moment(year + '/01/01', 'YYYY/MM/DD'),
            to: moment(year + '/02/01', 'YYYY/MM/DD'),
            title: 'Январь ' + year + ' г.',
            sort: 1
          },
          'February': {
            from: moment(year + '/02/01', 'YYYY/MM/DD'),
            to: moment(year + '/03/01', 'YYYY/MM/DD'),
            title: 'Февраль ' + year + ' г.',
            sort: 1
          },
          'March': {
            from: moment(year + '/03/01', 'YYYY/MM/DD'),
            to: moment(year + '/04/01', 'YYYY/MM/DD'),
            title: 'Март ' + year + ' г.',
            sort: 1
          },
          '1stQuarter': {
            from: moment(year + '/01/01', 'YYYY/MM/DD'),
            to: moment(year + '/04/01', 'YYYY/MM/DD'),
            title: 'ИТОГО за 1 квартал ' + year + ' г.',
            sort: 1
          },
          'April': {
            from: moment(year + '/04/01', 'YYYY/MM/DD'),
            to: moment(year + '/05/01', 'YYYY/MM/DD'),
            title: 'Апрель ' + year + ' г.',
            sort: 2
          },
          'May': {
            from: moment(year + '/05/01', 'YYYY/MM/DD'),
            to: moment(year + '/06/01', 'YYYY/MM/DD'),
            title: 'Май ' + year + ' г.',
            sort: 2
          },
          'June': {
            from: moment(year + '/06/01', 'YYYY/MM/DD'),
            to: moment(year + '/07/01', 'YYYY/MM/DD'),
            title: 'Июнь ' + year + ' г.',
            sort: 2
          },
          '2ndQuarter': {
            from: moment(year + '/04/01', 'YYYY/MM/DD'),
            to: moment(year + '/07/01', 'YYYY/MM/DD'),
            title: 'ИТОГО за 2 квартал ' + year + ' г.',
            sort: 2
          },
          '1stHalf': {
            from: moment(year + '/01/01', 'YYYY/MM/DD'),
            to: moment(year + '/07/01', 'YYYY/MM/DD'),
            title: 'ИТОГО за 1 полугодие ' + year + ' г.',
            sort: 3
          },
          'July': {
            from: moment(year + '/07/01', 'YYYY/MM/DD'),
            to: moment(year + '/08/01', 'YYYY/MM/DD'),
            title: 'Июль ' + year + ' г.',
            sort: 2
          },
          'August': {
            from: moment(year + '/08/01', 'YYYY/MM/DD'),
            to: moment(year + '/09/01', 'YYYY/MM/DD'),
            title: 'Август ' + year + ' г.',
            sort: 4
          },
          'September': {
            from: moment(year + '/09/01', 'YYYY/MM/DD'),
            to: moment(year + '/10/01', 'YYYY/MM/DD'),
          ...
          '3thQuarter': {
            from: moment(year + '/07/01', 'YYYY/MM/DD'),
            to: moment(year + '/10/01', 'YYYY/MM/DD'),
            title: 'ИТОГО за 3 квартал ' + year + ' г.',
            sort: 4
          },
          'October': {
            from: moment(year + '/10/01', 'YYYY/MM/DD'),
            to: moment(year + '/11/01', 'YYYY/MM/DD'),
            title: 'Октябрь ' + year + ' г.',
            sort: 4
          },
          'November': {
            from: moment(year + '/11/01', 'YYYY/MM/DD'),
            to: moment(year + '/12/01', 'YYYY/MM/DD'),
            title: 'Ноябрь ' + year + ' г.',
            sort: 5
          },
          'December': {
            from: moment(year + '/12/01', 'YYYY/MM/DD'),
            to: moment((year + 1) + '/01/01', 'YYYY/MM/DD'),
          ...
          '4thQuarter': {
            from: moment(year + '/10/01', 'YYYY/MM/DD'),
            to: moment((year + 1) + '/01/01', 'YYYY/MM/DD'),
            title: 'ИТОГО за 4 квартал ' + year + ' г.',
            sort: 5
          },
          '2ndHalf': {
            from: moment(year + '/07/01', 'YYYY/MM/DD'),
            to: moment((year + 1) + '/01/01', 'YYYY/MM/DD'),
            title: 'ИТОГО за 2 полугодие ' + year + ' г.',
            sort: 6
          },
          'Year': {
            from: moment(year + '/01/01', 'YYYY/MM/DD'),
